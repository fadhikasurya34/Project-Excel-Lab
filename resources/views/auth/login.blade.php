            ...
            <div class="panel-logo bg-emerald-50 dark:bg-emerald-950/20 flex flex-row md:flex-col items-center justify-center gap-4 dark:border-emerald-900/50">
                ...
                <div class="text-left md:text-center leading-none">
                    ...
                    <div class="brand-badge mt-2 hidden md:inline-flex items-center px-2 py-0.5 bg-emerald-500 text-white rounded-full">
                        ...
                        <span class="text-[8px] font-black tracking-widest uppercase">Sistem Siap</span>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-form flex flex-col justify-center">
                <div class="form-content w-full">
                    <div class="form-header mb-6">
                        <h1 class="text-2xl md:text-3xl font-black text-slate-900 dark:text-white uppercase leading-none tracking-tighter">LOGIN</h1>
                        <p class="text-xs text-slate-400 dark:text-slate-500 font-medium mt-2">Masuk ke terminal praktikan untuk memulai misi.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-4">
                        ...
                        <div class="space-y-1">
                            <div class="flex justify-between items-center px-1">
                                <label class="text-[10px] font-black text-slate-400 dark:text-slate-500 tracking-widest">Password</label>
                                <a href="{{ route('password.request') }}" class="text-[9px] font-bold text-emerald-600 uppercase">Lupa?</a>
                            </div>
                            <div class="relative">
                        ...
                        <div class="flex items-center px-2 pt-1">
                            <label class="flex items-center cursor-pointer group">
                                ...
                                <span class="ml-2 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Ingat Sesi</span>
                            </label>
                        </div>
