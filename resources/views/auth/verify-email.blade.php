...
<head>
    ...
    <title>Emerald Terminal - Verifikasi Email</title>
    ...
    <style>
        ...
        @media (orientation: landscape) and (max-height: 500px) {
            ...
            .form-content { max-width: 280px !important; margin: 0 auto; } 
            ...
            .form-header h1 { font-size: 1.3rem !important; }
            .form-header p { font-size: 9px !important; margin-top: 2px !important; }
            
            .info-text { font-size: 10px !important; line-height: 1.4 !important; margin-bottom: 1rem !important; }
        ...
        @media (min-width: 1024px) {
            ...
            .form-content { max-width: 340px; margin: 0 auto; }
        }
    </style>
</head>
<body class="bg-lab antialiased">
    ...
    <div x-show="toast.show" x-cloak 
         class="toast-top bg-white dark:bg-slate-800 border-2 border-emerald-500 border-bottom-[6px] border-b-emerald-700 rounded-2xl p-3 shadow-2xl flex items-center space-x-3 min-w-[280px]">
        ...
        <button @click="toast.show = false" class="text-slate-400 hover:text-emerald-500 transition-colors">
        ...
        <div class="main-container card-emerald dark:bg-slate-900 shadow-2xl">
            ...
            <div class="panel-logo bg-emerald-50 dark:bg-emerald-950/20 flex flex-row md:flex-col items-center justify-center gap-4 dark:border-emerald-900/50">
                ...
                <div class="text-left md:text-center leading-none">
                    <h2 class="brand-title font-extrabold text-2xl md:text-4xl tracking-tight text-excel-dark dark:text-emerald-400 uppercase leading-none">VIRTUAL LAB</h2>
                    <div class="brand-badge mt-2 hidden md:inline-flex items-center px-2 py-0.5 bg-emerald-500 text-white rounded-full">
                        ...
                        <span class="text-[8px] font-black tracking-widest uppercase">Verifikasi</span>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-form flex flex-col justify-center">
                <div class="form-content w-full">
                    <div class="form-header mb-6">
                        <h1 class="text-2xl md:text-3xl font-black text-slate-900 dark:text-white uppercase leading-none tracking-tighter">EMAIL</h1>
                        <p class="text-xs text-slate-400 dark:text-slate-500 font-medium mt-2">Satu langkah lagi untuk memulai misi.</p>
                    </div>

                    <div class="info-text text-xs text-slate-500 dark:text-slate-400 leading-relaxed mb-6 font-medium">
                        Terima kasih telah bergabung! Silakan verifikasi email Anda dengan mengeklik tautan yang baru saja kami kirimkan ke alamat Anda.
                    </div>

                    <div class="space-y-3 btn-group">
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="w-full">
                            @csrf
                            <button type="submit" class="w-full btn-excel btn-secondary bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-300 font-black text-xs md:text-sm py-3 rounded-xl text-center border-slate-300 dark:border-slate-700 uppercase tracking-tighter">
                                Keluar / Logout
                            </button>
                        </form>
                    </div>
