...
<head>
    ...
    <title>Emerald Terminal - Reset Password</title>
            ...
            <div class="panel-logo bg-emerald-50 dark:bg-emerald-950/20 flex flex-row md:flex-col items-center justify-center gap-4 dark:border-emerald-900/50">
                ...
                <div class="text-left md:text-center leading-none">
                    ...
                    <div class="brand-badge mt-2 hidden md:inline-flex items-center px-2 py-0.5 bg-emerald-500 text-white rounded-full">
                        ...
                        <span class="text-[8px] font-black tracking-widest uppercase">Reset Akses</span>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-form flex flex-col justify-center">
                <div class="form-content w-full">
                    <div class="form-header mb-6">
                        ...
                        <p class="text-xs text-slate-400 dark:text-slate-500 font-medium mt-2">Amankan kembali akun terminal Anda.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                        ...
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-slate-400 dark:text-slate-500 ml-1 capitalize">Identitas email</label>
                            <input type="email" name="email" value="{{ old('email', $request->email) }}" required readonly
                                   class="input-lab w-full px-4 py-3 rounded-xl text-sm font-bold opacity-60 cursor-not-allowed shadow-inner" 
                        ...
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-slate-400 dark:text-slate-500 ml-1 capitalize">Ulangi kunci akses</label>
