...
<div class="px-4 sm:px-10 py-8 main-wrapper" x-data="{ activeTab: 'belajar' }">
    <div class="max-w-4xl mx-auto inner-wrapper">
        ...
        {{-- Navigasi Tab --}}
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mb-12 w-full max-w-4xl mx-auto">
            <button @click="activeTab = 'belajar'" 
                    ...
                    class="w-full flex items-center justify-center gap-2 px-4 py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] border-2 transition-all duration-200">
                <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                <span class="truncate">Peta Alur</span>
            </button>
            ...
            <button @click="activeTab = 'mekanisme'" 
                    ...
                    class="w-full flex items-center justify-center gap-2 px-4 py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] border-2 transition-all duration-200">
                <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span class="truncate">Cara Main & Skor</span>
            </button>
            ...
            <button @click="activeTab = 'faq'" 
                ...
                <span class="truncate">FAQ & Bantuan</span>
            </button>
        </div>
