    ...
    <div class="app-wrapper">
        ...
        <nav class="shrink-0 h-[72px] flex items-center justify-between px-4 md:px-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b-2 border-slate-200/50 dark:border-slate-800/50 z-40">
            ...
            <div class="flex items-center space-x-2 md:space-x-3">
                {{-- 1. Tombol Home (Hanya muncul di Desktop/Tablet) --}}
                <a href="{{ route('dashboard') }}" 
                class="hidden md:flex w-10 h-10 md:w-11 md:h-11 items-center justify-center rounded-xl btn-pegas bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 text-slate-500 dark:text-emerald-400 shadow-xl">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                </a>

                {{-- 2. Tombol Theme Toggle (Hanya muncul di Desktop/Tablet) --}}
                <button @click="toggleTheme()" 
                        class="hidden md:flex w-10 h-10 md:w-11 md:h-11 items-center justify-center rounded-xl btn-pegas bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700">
                ...
                {{-- 3. Tombol Profile & Sidebar (Tetap muncul di Mobile & Desktop) --}}
