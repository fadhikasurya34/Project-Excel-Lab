    ...
    <div class="app-wrapper">
        ...
        <nav class="shrink-0 h-[72px] flex items-center justify-between px-4 md:px-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b-2 border-slate-200/50 dark:border-slate-800/50 z-40">
            ...
            <div class="flex items-center space-x-2 md:space-x-3">
                ...
                class="hidden md:flex w-10 h-10 md:w-11 md:h-11 items-center justify-center rounded-xl btn-pegas bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 text-slate-400 hover:text-emerald-500">
