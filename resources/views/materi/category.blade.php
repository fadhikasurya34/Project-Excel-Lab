...
<div class="px-4 sm:px-10 py-8 flex flex-col items-center" x-data="{ searchQuery: '' }">
    ...
    <div class="w-full max-w-md sm:max-w-3xl lg:max-w-5xl mx-auto transition-all duration-500">
        ...
        {{-- //* (Header & Search Bar) Deskripsi Folder --}}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 mb-16" x-ref="moduleGrid">
        ...
        @if($materials->isNotEmpty())
            <div x-cloak 
                 x-show="searchQuery.length > 0 && Array.from($refs.moduleGrid.children).every(el => el.style.display === 'none')" 
                ...
                <p class="text-slate-500 dark:text-slate-400 font-bold text-sm">Tidak menemukan modul yang mengandung kata <br><span class="text-blue-500" x-text="`&quot;${searchQuery}&quot;`"></span></p>
            </div>
        @endif
